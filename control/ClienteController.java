...
public class ClienteController {
	...
	public static void inserisci (String nome, String cognome, String email, String codicefiscale, String data) {
		...
		}else if(codicefiscale.length()!=16) {//Controllo successivo: mail ben posta e codice fiscale di 16 caratteri
	...
	public static void generaStatisticheCliente(String CodiceFiscale, String anno) {
		...
		BarChart chart = new BarChart("Istogramma","Spesa per mese nel " + anno, "", "Costo in €", dataset);
